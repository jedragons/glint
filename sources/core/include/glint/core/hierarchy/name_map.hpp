...
class NameComp {
  public:
    static auto on_construct(entt::registry& registry, entt::entity e) -> void;
    static auto on_update(entt::registry& registry, entt::entity e) -> void;
    static auto on_destroy(entt::registry& registry, entt::entity e) -> void;
